...
public class DatabaseInterface {
    ...
    public static boolean testForManager(String password, String User){
        return false;
    }
    
     public static boolean testForEmployee(String password, String User){
        return false;
    }
    ...
    public static Manager searchManagers() {
